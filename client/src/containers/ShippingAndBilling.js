...
export default function ShippingAndBilling(props) {
    ...
    return (
        <div className="shipping-billing">
            <form onSubmit={saveUserShipping} >
                <div className="shipping-billing-wrapper">
                    ...
                    <div>
                        ...
                        <div className={showShippingData? "shipping-form-hidden": "shipping-billing-active"}>  
                ...
                <div className="shipping-action billing-shipping-continue">
                    ...
                    {showShippingData? 
                    <button className="save-edit continue-button" onClick={saveUserShipping}>CONTINUE</button>:
                    <button type="submit" className="save-edit continue-button">CONTINUE</button>
                    }
                </div> 
            </form> 
        </div>
